<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>调货应付积分（按调货联系人）</el-breadcrumb-item>
		</el-breadcrumb>
  ...
  export default({
    ...
    methods:{
      viewReturnDetail(row){
        ...
        this.$router.push({path:`/main/reportAllotsReturnMoneyPayDetail`,query:{contactId:row.contacts_id}});
      },
      ...
      getSalesRefundMoney(){
        var _self = this;
        _self.listData=[];
				this.jquery('/iae/report/getAllotsReturnPayByContacts',null,function(res){
