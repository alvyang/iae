  ...
  <div>
    ...
    <div v-show="params.hospital_type == '调货单位'"  style="padding:10px;border:1px solid #ffffff;background-color:#ffffff;">
      <el-table :data="listData1" size="mini" :border="true" :span-method="objectSpanMethodAllot">
        <el-table-column fixed prop="hospitalName" label="调货单位" width="150"></el-table-column>
...
<script>
  ...
  export default({
    ...
    methods:{
      ...
      getComprehensive(){
        var _self = this;
        this.jquery('/iae/reportComprehensive/getReportComprehensive',_self.params,function(res){
						_self.listData= res.message;
        });
      },
      getComprehensiveAllot(){
        var _self = this;
        this.jquery('/iae/reportComprehensive/getReportComprehensiveAllot',_self.params,function(res){
