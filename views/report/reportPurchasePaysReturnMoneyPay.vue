<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>预付招商应付积分（按业务员）</el-breadcrumb-item>
		</el-breadcrumb>
  ...
  export default({
    ...
    methods:{
      viewReturnDetail(row){
        ...
        this.$router.push({path:`/main/reportPurchasePaysReturnMoneyPayDetail`,query:{contactId:row.contacts_id}});
      },
      ...
      getSalesRefundMoney(){
        var _self = this;
        _self.listData=[];
				this.jquery('/iae/report/getPurchasePayPaysReturnByContacts',null,function(res){
          console.log(res);
