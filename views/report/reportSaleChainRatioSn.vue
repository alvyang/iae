<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>产品销售量统计（环比）表格</el-breadcrumb-item>
		</el-breadcrumb>
    ...
    <div style="margin-top:10px;padding:10px;border:1px solid #ffffff;background-color:#ffffff;">
      <el-table :data="listData" style="width: 100%" size="mini" :stripe="true" :border="true">
          ...
          <el-table-column v-for="t in time" :label="t" :prop="t+'sn'"  width="80" :formatter="formatNumber">
            <!-- <el-table-column :prop="t" label="销售额" :formatter="formatNumber"></el-table-column> -->
            <!-- <el-table-column :prop="t+'sn'" label="销售量" :formatter="formatNumber"></el-table-column> -->
          </el-table-column>
          <el-table-column fixed="right" prop="sum" label="销售总量" width="100"></el-table-column>
...
<script>
  ...
  export default({
    ...
    activated(){
      this.getProductSalesByChainRatio();
    ...
    methods:{
      showImage(scope){
        this.imageTitle = scope.row.product_common_name+"  销售量环比柱状图"
      ...
      getProductSalesByChainRatio(){
        ...
        this.jquery('/iae/report/getReportSaleChainRatio',{
					data:_self.params,
          page:page,
          type:"sn"
        },function(res){
