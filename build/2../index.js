  ...
  data: function data() {
    ...
    var validatePercent = function validatePercent(rule, value, callback) {
      if (value && !/^100.00$|100$|^(\d|[1-9]\d)(\.\d+)*$/.test(value)) {
        ...
        _this.policyPay.purchase_pay_policy_price = _this.policyPay.purchase_pay_policy_price ? _this.policyPay.purchase_pay_policy_price : Math.round(temp * 100) / 100;
        callback();
      }
    };
...
var _tagInput = __webpack_require__(399);
